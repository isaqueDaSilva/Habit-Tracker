            ...
            List {
                ForEach(viewModel.search) { search in
                    NavigationLink(destination: {
                        DetailView(viewModel: viewModel, activity: search, name: search.name, description: search.description, icone: search.icone, repeatIn: search.repeatIn, priority: search.priority, activityRecord: search.activityRecord, previousActivity: search.previousActivity, timeRemaining: search.timeRemaining, progress: search.progress)
                    }, label: {
